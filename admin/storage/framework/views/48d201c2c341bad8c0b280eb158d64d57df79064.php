    ...
    <tr>
        <td style="<?php echo e($style['email-wrapper']); ?>" align="center">
            <table width="100%" cellpadding="0" cellspacing="0">
                <!-- Logo -->
                <tr>
                    <td style="<?php echo e($style['email-masthead']); ?>" bgcolor="#1c202b">
                        <a style="<?php echo e($fontFamily); ?> <?php echo e($style['email-masthead_name']); ?>" href="#" target="_blank">
                          Job Portal
                            ...
                            <tr>
                                <td style="<?php echo e($fontFamily); ?> <?php echo e($style['email-body_cell']); ?>">
                                    ...
                                    <h1 style="<?php echo e($style['header-1']); ?>">
                                        Hello <span style="text-transform:uppercase;"><?php echo e($user->full_name); ?>,
                                    </h1>
                                    ...
                                    <a href='<?php echo e(url("api/register-seeker/confirm/{$user->token}")); ?>'
                                       target="_blank">
                                        <?php echo e(url("api/register-seeker/confirm/{$user->token}")); ?>
                            ...
                            <tr>
                                <td style="<?php echo e($fontFamily); ?> <?php echo e($style['email-footer_cell']); ?>">
                                    <p style="<?php echo e($style['paragraph-sub']); ?>">
                                        ...
                                        <a style="<?php echo e($style['anchor']); ?>" href="<?php echo e(url('/')); ?>" target="_blank">Job Portal</a>.
                                        All rights reserved.
                                    </p>
                                </td>
                            </tr>
