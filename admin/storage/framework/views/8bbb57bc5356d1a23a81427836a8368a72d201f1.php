...
<h1>
    URL::   <?php echo e(url('/').'/api/seeker-profile-detail-on-job'); ?>


</h1>
<form method="POST" enctype="multipart/form-data" action="<?php echo e(url('/api/seeker-profile-detail-on-job')); ?>" >
    ...
    Job(job_id) ::<span style="color: red">*</span>  <select name="job_id">
        <option value="">Please select</option>
        <?php $__currentLoopData = $jobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key_job => $value_job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($value_job['id']); ?>"><?php echo e($value_job['specialization']); ?></option>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </select>
    <br />
    <br />
