app.controller("userhomeCtrl", function($http,$timeout,$rootScope,$scope,$location,$routeParams,getData,senddataPost,sendPostjson) {
...
$http.defaults.headers.post["Content-Type"] = "application/json";
    ...
    var postdata = {"value":'',"seeker_id":user_deatils.id,"job_location":[],"specialization":[],"qualification":[],"job_by_roles":[],"area_of_sector":[],"experience":[],"job_type":[]};
 ...
 $scope.experienceArray = [];  
  ...
  $timeout(function(){
          // var postdata = {"value":$scope.keyword,"seeker_id":user_deatils.id,"job_location":$scope.locationArray,"specialization":[],"qualification":$scope.qualificationArray,"job_by_roles":$scope.designationArray,"area_of_sector":[],"experience": $scope.experienceArray,"job_type":$scope.jobtypeArray};
    var postdata = {"value":$scope.keyword,"seeker_id":user_deatils.id,"job_location":$scope.locationArray,"specialization":[],"qualification":$scope.qualificationArray,"job_by_roles":$scope.designationArray,"area_of_sector":[],"experience": $scope.experienceArray,"job_type":$scope.jobtypeArray};
